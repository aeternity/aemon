...
test('Encode MicroBlock Object', t => {
    // console.dir(serializer.encodeObject(microBlock), {maxArrayLength: null})
    t.deepEqual(
        serializer.encodeObject(microBlock),
        microBlockData
    )
})
...
test('Decode MicroBlock Object', t => {
    t.deepEqual(
        serializer.decodeObject('micro_block', microBlockData),
        microBlock
    )
})
...
test('Encode KeyBlock Object', t => {
    // console.dir(serializer.encodeObject(keyBlock), {maxArrayLength: null})
    t.deepEqual(
        serializer.encodeObject(keyBlock),
        keyBlockData
    )
})
...
test('Decode KeyBlock Object', t => {
    t.deepEqual(
        serializer.decodeObject('key_block', keyBlockData),
        keyBlock
    )
})
